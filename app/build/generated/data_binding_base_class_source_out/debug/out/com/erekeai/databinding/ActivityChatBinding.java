...
public final class ActivityChatBinding implements ViewBinding {
  ...
  private ActivityChatBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView chatRecycler,
      @NonNull EditText messageInput, @NonNull Button sendBtn) {
  ...
  public static ActivityChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityChatBinding((LinearLayout) rootView, chatRecycler, messageInput, sendBtn);
    }
